...
const logger = winston.createLogger({
    ...
    transports: [
        ...
        new DailyRotateFile({filename: 'logs/%DATE%-commands.log', level: 'COMMAND', datePattern: 'YYYY-MM-DD', zippedArchive: true, maxSize: '1m', json: false, format: winston.format.combine(timeStampFormat,myFormat,formatOnlyLevel('COMMAND'))}),
